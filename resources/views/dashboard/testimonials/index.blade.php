...
@section('title', 'Opinie - Site Wizard')
@section('page', 'Opinie')
...
<div class="w-full flex gap-2 wrap flex-col sm:flex-row sm:justify-between">
    ...
    <a href="{{route('testimonials.create')}}" class="text-white bg-main-300 p-2 rounded-lg w-full sm:w-fit"><i
...
<div class="bg-white border-[1px] border-gray-200 p-2 w-full rounded-2xl flex flex-col gap-4">
    <table class="border-separate border-spacing-4">
        <tr
            ...
            <th class="hidden md:table-cell p-2 text-left text-gray-100 text-[14px] font-medium">Imię i nazwisko</th>
            <th class="hidden md:table-cell p-2 text-left text-gray-100 text-[14px] font-medium">Stanowisko</th>
