<aside
    ...
    <div class="flex flex-col gap-2 p-5">
        <a class="text-base w-full rounded-lg text-gray-100 p-4
            ...
            href="#">
            <i class="fa-solid fa-users text-lg text-main-300"></i>
            Klienci
        </a>
        <a class="text-base w-full rounded-lg text-gray-100 p-4
            flex flex-row gap-3 items-center justify-start hover:no-underline hover:bg-main-200 ease-in-out duration-200"
            href="#"><i class="fa-solid fa-comments text-lg text-main-300"></i>Wyślij wiadomość</a>
        <a class="text-base w-full rounded-lg text-gray-100 p-4
            flex flex-row gap-3 items-center justify-start hover:no-underline hover:bg-main-200 ease-in-out duration-200"
            href="#"><i class="fa-solid fa-handshake text-lg text-main-300"></i>Oferty</a>
    </div>
    <ul class="flex flex-col gap-2 p-5">
        <li>
            <div data-attribute="dropdown"
