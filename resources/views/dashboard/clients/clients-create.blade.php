...
<h2 class="section-heading">Dodaj klienta</h2>
<div class="dashboard-block block-50">
    <form method="POST" action="{{route('clients.store-dashboard')}}" class="dashboard-form">
        @csrf
        @method('POST')
        ...
        <div class="form-half-group">
            ...
            <div class="dashboard-form-group">
                <label for="nip" class="dashboard-label">NIP</label>
                <input name="nip" type="text" class="dashboard-input" placeholder="Zacznij wprowadzać..."
                    value="{{old('nip')}}">
                @error('company')
                <p>Błąd</p>
                @enderror
        ...
        <div class="dashboard-form-group">
            ...
            <select class="dashboard-input" name="country">
